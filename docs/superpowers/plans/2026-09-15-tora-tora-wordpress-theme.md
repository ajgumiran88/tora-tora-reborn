...
6. Package Dropbox/Figma brand assets (logo, pattern WebP/PNG, delivery logos) and fallbacks; validate PHP, JavaScript, accessibility-related markup, local asset references, and ZIP layout.
